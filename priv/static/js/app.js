...
var _repository_channel = require('./channels/repository_channel');

var _repository_channel2 = _interopRequireDefault(_repository_channel);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var userId = $("meta[name='user_id']").attr('content');
var userToken = $("meta[name='user_token']").attr('content');

var socket = _socket2.default.connect(userToken);
(0, _repository_channel2.default)(socket, userId);

console.log("done");
});

;require.register("web/static/js/channels/repository_channel.js", function(exports, require, module) {
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = repositoryChannelHandler;
/* global $ */
function repositoryChannelHandler(socket, userId) {
  var channel = socket.channel('repository:list:' + userId, {});
  ...
  channel.on('repositories_updated', function (payload) {
...
exports.default = {
  connect: function connect(userToken) {
    if (userToken) {
      var socket = new _phoenix.Socket('/socket', { params: { token: userToken } });
      socket.connect();
      return socket;
    }
  }
